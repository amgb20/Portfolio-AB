...
function Education({ position, company, location, type, duration, grade, logo }) {
  ...
  return (
    <article ref={refsEduc} className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      {/* Row 1: Title and Type Badge */}
      <div className="flex justify-between items-start">
        <h1 className="text-content md:text-lg lg:text-xl font-medium">{position}</h1>
        <div className="btn bg-greenbg text-green-text text-xs inline-block rounded-3xl px-3 py-1 min-w-fit ml-4">
          {type}
        </div>
      </div>
      
      {/* Row 2: Institution, Location, Duration and Logo */}
      ...
      {/* Row 3: Grade and additional info */}
