...
function Work({ position, company, location, type, duration, grade, logo, logoSize }) {
  ...
  return (
    <article ref={refsEduc} className="group p-4 md:p-6 mt-4 bg-white dark:bg-dark-card rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
        ...
        <div className="flex items-start gap-4">
          {logo && (
            <img
              src={logo}
              alt={`${company} logo`}
              className="w-12 h-12 md:w-16 md:h-16 object-contain rounded-lg bg-white p-1"
            />
          )}
          <div>
            ...
            <p className="text-dark-content dark:text-light-content text-sm mt-1">{company}</p>
          </div>
        </div>
        <span className="inline-flex self-start px-3 py-1 text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-full">
          {type}
        </span>
      </div>
      <div className="flex flex-wrap gap-4 mt-4 text-sm text-dark-content dark:text-light-content">
        <div className="flex items-center gap-1.5">
          <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 16 12" xmlns="http://www.w3.org/2000/svg">
        ...
        {grade && (
          <div className="flex items-center gap-1.5">
            <svg className="w-4 h-4 flex-shrink-0 text-yellow-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
