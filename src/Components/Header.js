...
function Header() {
  ...
  return (
    <>
      <ScrollToTop />
      <header className="container mx-auto md:flex justify-between py-2 max-width sticky top-0 z-50 bg-white dark:bg-dark-mode transition-colors duration-300">
        <div className="flex justify-between items-center py-2 md:py-6">
          <NavLink to="/" className="transform hover:scale-105 transition-transform duration-300">
            <span className="name-logo text-xl sm:text-2xl md:text-3xl">Alexandre Benoit</span>
          </NavLink>
          <div className="flex items-center gap-4 md:hidden">
            ...
            >
              <div className={`hamburger-icon ${isOpen ? 'open' : ''}`}>
                <svg
                  className="stroke-dark-heading dark:stroke-white transition-transform duration-300"
                  width="24"
                  height="20"
                  viewBox="0 0 16 13"
                  fill="none"
        ...
        <nav className={`mobile-nav ${isOpen ? 'mobile-nav-open' : 'mobile-nav-closed'} md:flex md:items-center text-center justify-between transition-all duration-300 ease-in-out overflow-hidden md:overflow-visible`}>
          ...
          <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-3">
            <li>
              <a 
                href={linkdein} 
                target="_blank" 
                rel="noreferrer noopener"
                className="block p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 transform hover:scale-110"
              >
                <svg
                  className="dark:fill-light-heading fill-dark-heading transition-colors duration-300"
                  width="24"
                  height="24"
                  viewBox="0 0 30 30"
                  fill="none"
