...
function Contact() {
  const { email, email_2, phone } = contactDetails;
  const { linkdein, github, googlescholar } = socialMediaUrl;
  
  return (
    <main className="container mx-auto max-width min-h-[calc(100vh-200px)] flex items-center py-12">
      <div className="w-full max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-dark-heading dark:text-light-heading font-bold leading-tight">
            Let's{" "}
            <span className="text-gradient">Connect</span>
          </h1>
          <p className="text-dark-content dark:text-light-content text-lg mt-4 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <a 
            href={`mailto:${email}`}
            className="group p-6 bg-white dark:bg-dark-card rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
          >
            <div className="flex items-center gap-4">
              <div className="p-3 bg-gradient rounded-xl">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <div>
                <h3 className="text-sm font-medium text-dark-content dark:text-light-content">Primary Email</h3>
                <p className="text-lg font-semibold text-dark-heading dark:text-light-heading group-hover:text-gradient transition-all duration-300 break-all">
                  {email}
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-sm font-medium text-dark-content dark:text-light-content">Secondary Email</h3>
                <p className="text-lg font-semibold text-dark-heading dark:text-light-heading group-hover:text-gradient transition-all duration-300 break-all">
                  {email_2}
                </p>
              </div>
        ...
        <div className="text-center">
          <h3 className="text-lg font-medium text-dark-heading dark:text-light-heading mb-6">
          ...
          <div className="flex justify-center gap-4">
            <a 
              ...
              className="p-4 bg-white dark:bg-dark-card rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-110"
            >
              <svg className="w-6 h-6 fill-dark-heading dark:fill-light-heading" viewBox="0 0 30 30">
            ...
            <a 
              ...
              className="p-4 bg-white dark:bg-dark-card rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-110"
            >
              <svg className="w-6 h-6 fill-dark-heading dark:fill-light-heading" viewBox="0 0 50 50">
